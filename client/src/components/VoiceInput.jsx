    ...
    return (
        <div className="bg-slate-50 p-4 sm:p-6 rounded-xl border border-slate-200">
            ...
            <div className="flex flex-wrap gap-3 items-center w-full">
                {!isRecording ? (
                    <button 
                        className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl transition-all shadow-sm shadow-blue-200 active:scale-95 text-sm" 
                    ...
                    <>
                        ...
                        <button 
                            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-red-500 hover:bg-red-600 text-white font-medium rounded-xl transition-all shadow-sm shadow-red-200 active:scale-95 animate-pulse text-sm" 
                        ...
                        <button 
                            type="button"
                            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-slate-200 hover:bg-slate-300 text-slate-700 font-medium rounded-xl transition-all active:scale-95 text-sm"
                ...
                <div className="mt-4 p-4 bg-slate-950 rounded-2xl border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                        ...
                        <div className="flex flex-col">
                            <span className="text-white text-base font-mono font-bold tracking-wider">
            ...
            {isUploading && (
                <div className="flex items-center gap-2.5 mt-4 p-3 bg-emerald-50 text-emerald-700 border border-emerald-100 rounded-xl text-sm font-medium animate-pulse">
                    <svg className="animate-spin w-5 h-5 text-emerald-600 shrink-0" fill="none" viewBox="0 0 24 24">
                        <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                        <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    Transcribing voice and generating legal response...
                </div>
            )}
        </div>
    );
