    ...
    return (
        <div className="bg-slate-50 p-4 sm:p-6 rounded-xl border border-slate-200">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center w-full">
                {!isRecording ? (
                    <button 
                        className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl transition-colors shadow-sm shadow-blue-200 active:scale-95 text-sm disabled:opacity-70 disabled:cursor-not-allowed" 
                    ...
                    <>
                        ...
                        <button 
                            ...
                            className="w-10 h-10 rounded-xl bg-slate-800 hover:bg-slate-700 text-amber-400 flex items-center justify-center transition-all cursor-pointer hover:scale-105 active:scale-95 border border-slate-700 shrink-0"
                        >
                            {isPaused ? (
                        ...
                        <button 
                            ...
                            className="w-10 h-10 rounded-xl bg-slate-200 hover:bg-slate-300 text-slate-600 flex items-center justify-center transition-all cursor-pointer hover:scale-105 active:scale-95 border border-slate-300 shrink-0"
                        >
                        ...
                        <div className="font-mono text-slate-600 font-medium ml-2">
            ...
            {isRecording && (
                <div className="w-full mt-4 bg-slate-900 rounded-xl overflow-hidden shadow-inner h-24 sm:h-32 relative">
                    <canvas ref={canvasRef} className="w-full h-full" width={800} height={128} />
                    <div className="absolute top-3 left-3 flex items-center gap-2 text-red-400 font-medium text-xs sm:text-sm">
